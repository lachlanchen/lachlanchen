...
| --- | --- | --- |
| One MCP server at one pinned repository revision, with up to eight tools and resources | An authority map, a sanitized ten-check protocol packet, and a narrow go/no-go report with one limited recheck | [Executed sample](https://lazying.art/mcp-boundary-review/sample-report/?utm_source=github&utm_medium=profile&utm_campaign=mcp_boundary_review&utm_content=profile_sample) · [Free public-repository preflight](https://lazying.art/mcp-boundary-review/?utm_source=github&utm_medium=profile&utm_campaign=mcp_boundary_review&utm_content=profile_preflight#preflight) · [Fit check](https://lazying.art/mcp-boundary-review/fit-check/?utm_source=github&utm_medium=profile&utm_campaign=mcp_boundary_review&utm_content=profile_fit_check) |
