...
| 🧩 **AutoAppDev** | 用于精简应用开发工作流的工具集 | [Repository](https://github.com/lachlanchen/AutoAppDev) |
| 📖 **AutoNovelWriter** | 面向长篇创作与故事生成的工作流系统 | [Repository](https://github.com/lachlanchen/AutoNovelWriter) |
| 🧠 **AgInTi** | 人形 AI 智能体实验与系统设计 | [Repository](https://github.com/lachlanchen/AgInTi) |

## 🎯 我关注的方向

**The Art of Lazying** 是指设计能够减少不必要投入、同时保留深度、质量与人类创造力的系统。
